...
exec('python query3.py MSFT',$var_name1);
echo '<br><br><br><br><br><br><div id="inside"><font id="pred" color="white">The average stock price of Microsoft in the last one year: $'.$var_name1[0].'</font></div>';
//echo "The average stock price of Microsoft in the last one year is - ".$var_name1[0]."<br>";
